...
import numpy as np
from full_model.live_chord_detector import LiveChordDetector

class ChordDetectorGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Live Chord Detector (Full Model)")
    ...
    def setup_gui(self):
        ...
        # Title
        title_label = ttk.Label(main_frame, text="Live Chord Detector (Full Model)", 
                               font=('Arial', 20, 'bold'))
