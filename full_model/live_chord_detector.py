...
class LiveChordDetector:
    def __init__(self, model_path="full_model/model.pkl", chunk_duration=1.0, overlap=0.5):
...
def main():
    ...
    print("Live Chord Detector (Full Model)")
    print("=" * 30)
    ...
    try:
        ...
        print("Error: full_model/model.pkl not found!")
