...
class LiveChordDetectorChroma:
    def __init__(self, model_path="chroma_model/model_chroma.pkl", chunk_duration=1.0, overlap=0.5):
        ...
        print("Loading trained chroma model...")
        ...
        print("Live chroma chord detector initialized!")
    ...
    def extract_chroma_features(self, audio_data):
        """Extract only chroma features from audio data (same as training)"""
        try:
            ...
            tuning_est = librosa.estimate_tuning(y=y, sr=self.sample_rate)
            y = librosa.effects.pitch_shift(y, sr=self.sample_rate, n_steps=-tuning_est)
    ...
    def process_audio_chunk(self, audio_chunk):
        ...
        features = self.extract_chroma_features(audio_chunk)
    ...
    def start_recording(self):
        ...
        try:
            ...
            print("Live chroma chord detection started!")
        ...
        try:
            while self.is_recording:
                ...
                if (self.current_chord != last_chord or 
                    ...
                    print(f"\rCurrent Chord: {self.current_chord:<12} "
    ...
    def stop_recording(self):
        ...
        print("\nLive chroma chord detection stopped!")
...
def main():
    """Main function to run the live chroma chord detector"""
    print("Live Chroma Chord Detector")
    print("=" * 30)
    
    # Check if model exists
    try:
        detector = LiveChordDetectorChroma()
    except FileNotFoundError:
        print("Error: model_chroma.pkl not found!")
        print("Please run train_model_chroma.py first to train the chroma model.")
        return
    except Exception as e:
